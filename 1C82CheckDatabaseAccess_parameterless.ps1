# PowerShell-скрипт «1C82CheckDatabaseAccess_parameterless.ps1» проверяет доступность базы данных на сервере приложений 1С 8.2 путем попытки подключения к базе.
...
# .\1C82CheckDatabaseAccess_parameterless.ps1 [-Verbose]

# -Verbose
#     Вывод подробных сообщений об ошибках (опционально, использовать только при отладке)
